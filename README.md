...
A live demo is deployed to ShinyApps.io [here](https://ranipowers.shinyapps.io/Shiny_auth_example/){target="_blank"}.
...
There are other ways to do Shiny app authentication with Google Sign-In (e.g. using the [GoogleAuthR](https://github.com/MarkEdmondson1234/GoogleAuthR){target="_blank"} package). I just liked this way and it was the easiest for me to get up and running quickly.

#### Run this Shiny app with your own Google account: 

1. Log in to the [GCP console](https://console.cloud.google.com/apis/credentials){target="_blank"} and create a new OAuth 2.0 client ID for a web application.
